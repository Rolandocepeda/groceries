 ...
 */
export class GroceryTableDataSource extends DataSource<GroceryTableItem> {
  data: GroceryTableItem[];

  constructor(private paginator: MatPaginator, private sort: MatSort, data: GroceryTableItem[]) {
    super();
    this.data = data;
  }
   ...
   */
  connect(): Observable<GroceryTableItem[]> {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: GroceryTableItem[]): GroceryTableItem[] {
